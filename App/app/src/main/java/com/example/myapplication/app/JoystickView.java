...
public class JoystickView extends View{
    ...
    private MoveListener myMoveListener;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredHeight = measure(widthMeasureSpec);
...
//                                      Log.d(TAG, "ACTION_POINTER_DOWN: " + pointerId);
    ...
    public void setMoveListener(MoveListener m) {
        this.myMoveListener = m;
    }
    ...
    private boolean processMoveEvent(MotionEvent ev) {
        if ( pointerId != INVALID_POINTER_ID ) {
            ...
            myMoveListener.moved(touchX, touchY);
            reportOnMoved();
            invalidate();
